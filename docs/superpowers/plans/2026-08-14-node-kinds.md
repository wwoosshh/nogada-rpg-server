...
- [ ] **천장은 상대, 바닥은 절대다. 둘을 같은 자로 재면 안 된다.**
      ...
      - **바닥 `SPECIAL_YIELD_MIN_STEP`(절대)**: 특수 표 **자신의** 분당 골드가
      ...
      **왜 바닥이 비가 아닌가 — 재 봤다.** §5 목표를 만족하는 `ice_special` 후보
      ...
      | 브라켓(하한 숙련) | `cum1` | 특수 G/분 | 바깥 G/분 | 비 |
      |---|---|---|---|---|
      | ≤500 (0) | 22 | 1,958 | 2,751 | 0.712 |
      | ≤5,000 (501) | 23 | 3,560 | 6,061 | 0.587 |
      | ≤10,000 (5,001) | 22 | 5,062 | 9,767 | 0.518 |
      | ≤150,000 (10,001) | 22 | 6,769 | 18,634 | 0.363 |
      | ≤500,000 (150,001) | 47 | 14,227 | 95,910 | 0.148 |
      | ∞ (500,001) | 61 | 23,543 | 1,678,956 | **0.014** |
